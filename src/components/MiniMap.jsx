...
//   return (
//     <div className={`pointer-events-auto absolute bottom-4  left-2 z-40 select-none  ${className}`} style={{ width, height }} onClick={handleClick}>
//       <div className=" w-full h-full p-1">
//         <canvas ref={canvasRef} className="block w-full h-full rounded  border-green-100 border-2 shadow-lg" />
//       </div>
//     </div>
//   );
// }
...
export default function MiniMap({ playgroundRef, width = 150, height = 150, className = "" }) {
  ...
  return (
    <div
      className={`pointer-events-auto absolute bottom-4 left-2 z-40 select-none ${className}`}
